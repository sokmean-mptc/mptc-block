...
class SlideList extends BaseController
{
    ...
    public function registerBlock() {
        register_block_type(
            $this->plugin_name . '/slidelist', array(
    ...
    public function renderPostsBlock( $attr ) {
        ...
        if ( $the_query->have_posts() ) :
            ...
            ?>
            <ul class="slick-slide-show p-0 row gx-3" data-slick='{ <?php echo $data_slick ?>, "responsive": [ <?php echo json_encode( $attr['data_slick_md'] ) ?>, <?php echo json_encode( $attr['data_slick_sm'] ) ?>, <?php echo json_encode( $attr['data_slick_xs'] ) ?> ] }'>
            <?php
                        ...
                        <figure class="p-0 m-0">
                            ...
                            <figcaption class="figcaption">
                                ...
                                <?php if( $attr['enable_title'] ) : ?>
                                    <h5 class="title mb-0 mb-1 mb-sm-1 mb-lg-2">
                                        <a href="<?php the_permalink(); ?>">
