...
registerBlockType( 'mptc-block/header', {
	title: 'Header',
	icon: 'admin-page',
	category: 'mptc-block',
	keywords: [ 'header' ],
			...
			<Fragment>
				<InspectorControls>
					...
					>		
						...
						/>
						<label className={'components-base-control__label css-pezhm9-StyledLabel  css-wdf2ti-Wrapper'}>{ 'Image Width (>1200px)' }</label>
						<NumberControl
							value={ xl }
							onChange={ ( value ) => setAttributes( { xl: value } ) }
						/>	
						<label className={'components-base-control__label css-pezhm9-StyledLabel  css-wdf2ti-Wrapper'}>{ 'Image Width (>992px)' }</label>
						<NumberControl
							value={ lg }
							onChange={ ( value ) => setAttributes( { lg: value } ) }
						/>	
						<label className={'components-base-control__label css-pezhm9-StyledLabel  css-wdf2ti-Wrapper'}>{ 'Image Width (>768px)' }</label>
						<NumberControl
							value={ md }
							onChange={ ( value ) => setAttributes( { md: value } ) }
						/>	
						<label className={'components-base-control__label css-pezhm9-StyledLabel  css-wdf2ti-Wrapper'}>{ 'Image Width (>576px)' }</label>
						<NumberControl
							value={ sm }
							onChange={ ( value ) => setAttributes( { sm: value } ) }
						/>	
						<label className={'components-base-control__label css-pezhm9-StyledLabel  css-wdf2ti-Wrapper'}>{ 'Image Width' }</label>
						<NumberControl
							value={ xs }
				...
				<section className="header-three position-relative mb-0 mb-lg-4">
					<header className="container d-flex align-items-center justify-content-between px-1 px-sm-2 px-md-3 py-1 py-sm-2 py-md-3 py-lg-4">
						<figure className="d-flex mb-0 logo">
							<a href={"#"}>
								<img 
									src={image_url}
									type={"image/jpeg"}   
						...
						<div className="d-flex align-items-center">
							...
							<div className="d-none d-lg-block search-icon text-center me-3 color-gray-500" data-bs-toggle="modal" data-bs-target="#searchModal">
							...
							<div className="mobile-toggle d-flex align-items-center d-lg-none">
								<div className="search-icon text-center me-1 me-sm-2 me-md-2 color-gray-300" data-bs-toggle="modal" data-bs-target="#searchModal">
								<i className="icofont-search-1"></i>
								</div>
					...
					<div id="particles-js" className="d-flex position-absolute bottom-0 start-0 end-0"></div>
				</section>
